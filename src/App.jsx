  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/CustomerSignIn" element ={<CustomerSignIn setCustomer={setCustomer} customer={customer} cart={cart}/>} />
        <Route path="/ShoppingCart" element={<ShoppingCart customer = {customer}  cart={cart}/>}  />   
      </Routes>
    </>
  )
}
